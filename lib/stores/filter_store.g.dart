...
mixin _$FilterStore on _FilterStore, Store {
  ...
  bool get isTypeProfessional => (_$isTypeProfessionalComputed ??=
          Computed<bool>(() => super.isTypeProfessional,
              name: '_FilterStore.isTypeProfessional'))
      .value;
  ...
  void save() {
    final _$actionInfo =
        _$_FilterStoreActionController.startAction(name: '_FilterStore.save');
    try {
      return super.save();
    } finally {
      _$_FilterStoreActionController.endAction(_$actionInfo);
  ...
  FilterStore clone() {
    final _$actionInfo =
        _$_FilterStoreActionController.startAction(name: '_FilterStore.clone');
    try {
      return super.clone();
    } finally {
      _$_FilterStoreActionController.endAction(_$actionInfo);
